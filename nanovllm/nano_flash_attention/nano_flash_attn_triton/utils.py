...
#
# e.g. FLASH_ATTENTION_FWD_TRITON_AMD_CONFIG_JSON='{"BLOCK_M":32,"BLOCK_N":32,"PRE_LOAD_V":false,"num_stages":1,"num_warps":4}'
...
def get_arch() -> GpuArch:
    ...
    name: str = triton.runtime.driver.active.get_current_target().arch['name']
    print(f"Detected GPU architecture: {name}")
